...
<div class="mav-card-wrapper">
    <div class="mav-card-ctn">
        <article id="mavid-post-<?php the_ID(); ?>" <?php post_class('mav-card-post sticky'); ?> data-post-id="<?php the_ID(); ?>">
            <!-- Post header -->
            ...
            <footer class="mav-card-post-footer">
                <?php
                    printf('<a href="%1$s" title="%2$s" class="mav-btn-secondary">%2$s</a>',get_the_permalink(),__('Xem chi tiết','maverick-theme'));
                ?>
            </footer>
        </article>
    </div>
