...
printf('<address class="mav-contact-info-wrapper mav-contact__info--wrp mav-padding__top__bottom">');
    printf('<ul class="mav-contact-info-ctn mav-contact__info--ctn">');
        // Address
        if ( !empty($mavAdress) ) {
            printf(
