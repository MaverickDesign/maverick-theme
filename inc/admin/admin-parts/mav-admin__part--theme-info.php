...
<!-- Theme Info -->
<div class="mav-admin-theme-info-wrapper">
    <div class="mav-admin-theme-info-ctn">
        <!-- Theme Info Header -->
        <header class="mav-theme-info-header">
        ...
        <div class="mav-theme-info-body">
            ...
            <section>
                <p>Với việc sử dụng <a href="http://www.maverick.vn/maverick-theme/" title="Đến trang Maverick Theme">Maverick Theme</a> cho website của bạn, đồng nghĩa với việc bạn đã đọc, hiểu rõ và chấp nhận các Điều khoản thỏa thuận và Điều kiện sử dụng của <a href="http://www.maverick.vn" title="Đến trang maverick.vn">Maverick Design</a>.</p>
                <p>Vui lòng không sử dụng <a href="http://www.maverick.vn/maverick-theme/" title="Đến trang Maverick Theme">Maverick Theme</a> nếu bạn không đồng ý với bất kỳ điều khoản, điều kiện nào của <a href="http://www.maverick.vn" title="Đến trang maverick.vn">Maverick Design</a>.</p>
            </section>
        </div>
    </div>
</div>